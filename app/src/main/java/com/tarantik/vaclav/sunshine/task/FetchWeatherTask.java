 ...
 */
package com.tarantik.vaclav.sunshine.task;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationQueryCursor.moveToFirst()) {
            int locationIdIndex = locationQueryCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
            locationId = locationQueryCursor.getLong(locationIdIndex);
        } else {
