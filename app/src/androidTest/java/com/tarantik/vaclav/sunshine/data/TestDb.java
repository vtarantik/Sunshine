 ...
 */
package com.tarantik.vaclav.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        float id = db.insert(WeatherContract.LocationEntry.TABLE_NAME,null,contentValues);
        assertTrue(id != -1);
        ...
        Cursor c = db.query(
                ...
                null, //colunns to filter by row groups
                null //sort order
        );
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("RECORD DOESN'T MATCH CURSOR CONTENT",c,contentValues);
    ...
    public void testWeatherTable() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("RECORD DOESN'T MATCH CURSOR CONTENT",c,weatherValues);
